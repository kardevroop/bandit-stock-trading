...
if __name__ == '__main__':
    ...
    if args.data == "SP500":
        companies.pop(0)
        with open(os.path.join(args.root_path, args.ticker_file)) as fopen:
    ...
    if args.is_training:
        for company in companies:
            print(f'[INFO]   Processing {company} data...')
            args.data_path = os.path.join('stocks', f"{company}.csv")
            if company == 'KMX':
                args.enc_in = 13
                args.dec_in = 13
                args.c_out = 13
            for ii in range(args.itr):
                ...
                setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_d{}_ld{}_lr{}_{}_{}'.format(
                    args.model_id,
                    args.model,
                    args.data if company == -1 else args.data + '_' + company,
                    args.features,
                    args.seq_len,
                    args.label_len,
                    args.pred_len,
                ...
                model, time_taken = exp.train(setting)
